                ...
                <div className='text-white flex items-center gap-2'>
                    {isLogin ? (
                        <div className="relative">
                            <button onClick={toggleDropdown} className='text-[#FF5F1F] bg-gray-200 bg-opacity-60 border border-gray-100 hover:bg-opacity-40 dark:hover:bg-opacity-70 dark:bg-neutral-900 dark:bg-opacity-90 dark:border dark:border-neutral-600 w-fit h-9 px-2 font-bold rounded-md flex gap-2 items-center justify-between'>
                                Account
                            ...
                            <div className={`absolute mt-2 w-fit md:w-48 transition-all duration-300 overflow-hidden ${dropdownOpen ? "max-h-96 opacity-100" : "max-h-0 opacity-0"} bg-white dark:bg-neutral-900 rounded-md shadow-lg z-20`}>
                                <Link href="/dashboard">
